...
import CustomCursor from './CustomCursor'; // 👈 import added here
          ...
          <div className="text-center">
            ...
            >
              ...
              <h1 className="text-5xl md:text-7xl font-extrabold text-white mb-4 tracking-tight leading-tight">
                <span className="font-serif">Sri Tejaswini</span>
                <span className="block text-teal-400 font-sans font-light tracking-widest">
                  Chundru
                </span>
              </h1>
              ...
              <motion.p
                ...
                className="text-xl md:text-2xl text-gray-300 mb-6 max-w-3xl mx-auto font-light tracking-wide"
              >
              ...
              <motion.p
                ...
                className="text-base md:text-lg text-gray-400 mb-12 max-w-4xl mx-auto leading-relaxed tracking-wide"
              >
            ...
            >
              <motion.button
                ...
                className="cursor-pointer border-2 border-blue-600 text-blue-600 px-8 py-3 rounded-full font-semibold hover:bg-blue-600 hover:text-white transition-all duration-200 tracking-wide"
              >
                Get In Touch
              </motion.button>
            </motion.div>
            ...
            >
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  className="cursor-pointer relative group w-12 h-12 bg-slate-700 rounded-full shadow-lg flex items-center justify-center text-gray-200 hover:text-white hover:shadow-xl transition-all duration-200"
                >
                  <social.icon size={20} />
                  {social.tooltip && (
